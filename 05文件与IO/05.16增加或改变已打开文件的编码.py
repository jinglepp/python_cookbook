...
# 如果你想修改一个已经打开的文本模式的文件的编码方式，
# 可以先使用 detach() 方法移除掉已存在的文本编码层，
...
f = open('sample.txt', 'w')
print(f)  # <_io.TextIOWrapper name='sample.txt' mode='w' encoding='cp936'>
print(f.buffer)  # <_io.BufferedWriter name='sample.txt'>
print(f.buffer.raw)  # <_io.FileIO name='sample.txt' mode='wb' closefd=True>
# f.close()
